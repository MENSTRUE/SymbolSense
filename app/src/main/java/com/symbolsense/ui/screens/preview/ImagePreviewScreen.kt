        ...
        Box(
            ...
            Box(
                modifier = Modifier
                    .fillMaxWidth()
                    .aspectRatio(4f / 3f)
                    .background(Color.White.copy(alpha = 0.04f), MaterialTheme.shapes.medium)
            ) {
                if (imageUri != null) {
                    AsyncImage(
                        model = imageUri,
...
private fun CropOverlay() {
    Canvas(Modifier.fillMaxSize()) {
        ...
        listOf(
            ...
            drawCircle(CyanAccent, radius, point)
            drawCircle(Color.White, radius * 0.45f, point)
        }
    }
}
